...
This page outlines how each practical session is set up. Before you begin in Week 1, you should also check out the [guidelines](0_setup.qmd) for setting up your workspace for this module.
...
![Artwork by \@allison_horst](images/ah_Rlearners.png){fig-alt="Header text \"R learners\" above five friendly monsters holding up signs that together read “we believe in you.”" fig-align="center" width="497"}
...
![Artwork by \@allison_horst](images/ah_livetroubleshooting.png){fig-alt="A little monster in a cool black jacket and sunglasses, leaning casually against a fence with a sign reading \"Warning! Live troubleshooting!\"" fig-align="center" width="329"}
